function [DOA_ls60] = LS_intp60(N,lambda,positions_x_nu,d,X_nu,positions_x_u,m,noise_variance,L,noise_vari)

%Search Sectors

search_angles_sector_1 = -90:1:-30;%Search vector sector 1
search_angles_sector_2 = -29:1:30;%Search vector sector 2
search_angles_sector_3 = 31:1:90;%Search vector sector 3
...
DOA_sector2= sort(2*(180*asin((rootmusic(X_i_s2*X_i_s2',2))/2/pi/d)/pi));
